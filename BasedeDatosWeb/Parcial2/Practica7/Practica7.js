        ...
        switch (posicion){
            ...
            case 4:
                ...
                if (cuadro4 == cuadro1 && cuadro4 == cuadro7){
                    console.log("WINNER ---->" + cuadro4)
                    pintar(1,4,7);
                } else if (cuadro4 == cuadro5 && cuadro4 == cuadro7){
                    console.log("WINNER ---->" + cuadro4)
                    pintar(4,5,6);
                }
                break;
